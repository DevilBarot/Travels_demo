...
public class PackDetail_hotel_adapter extends RecyclerView.Adapter<PackDetail_hotel_adapter.MyViewHolder> {
    String id, cat_name;
    private List<PackageDetail_model> model;
    private Context context;
    LayoutInflater inflater;
    PackageDetail_model category;
    Boolean flag = true;

    public PackDetail_hotel_adapter(Context context, List<PackageDetail_model> model) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Log.e("hotelllll", "" + category.getHotel_description());
        ...
        holder.txt_rooom_type.setText(category.getHotel_rooms_type());
        ...
        Glide.with(context).load(category.getHotel_images()).into(holder.img_hotel);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView txt_hotel_desc, txt_hotel_title, txt_meals, txt_rooom_type,txt_checkin,txt_checkout;
