...
public class Login extends Fragment implements View.OnClickListener {
    ...
    private void Loginapi() {
        ...
        String URL = Main_Url.sortUrl + "user_login.php?";
        Log.e("trace", URL);
        final StringRequest request = new StringRequest(StringRequest.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Log.e("msg", "" + status);
                    JSONObject i = new JSONObject(user_data);
                    ...
                    if (status.equals("success")) {
                         if (getActivity() != null) {
                            try {
                                ...
                                Log.e("object", "" + i);
                                Log.e("User_Id", "" + i.getString("User_Id"));
                                Log.e("first_name", "" + i.getString("first_name"));
                                Login_preference.setcustomer_id(getActivity(),i.getString("User_Id"));
